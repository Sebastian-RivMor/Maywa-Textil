    ...
    <div class="grid grid-cols-4 gap-6 h-[calc(422px-3rem)]"> 
      ...
      <a href="/categorias/chompas" class="group text-center">
        <div class="rounded-[30px] overflow-hidden shadow-md ring-1 ring-black/10 h-[300px]">
          <img src="assets/img/turista.png" alt="Chompas"
               class="w-full h-full object-cover transition-transform duration-200 group-hover:scale-[1.03]" />
        </div>
        <p class="mt-3 text-base font-medium text-white">Chinchero, Perú</p>
      </a>

      <a href="/categorias/ponchos" class="group text-center">
        <div class="rounded-[30px] overflow-hidden shadow-md ring-1 ring-black/10 h-[300px]">
          <img src="assets/img/tienda.png" alt="Ponchos"
               class="w-full h-full object-cover transition-transform duration-200 group-hover:scale-[1.03]" />
        </div>
        <p class="mt-3 text-base font-medium text-white">Pisac, Cusco</p>
      </a>

      <a href="/categorias/carteras" class="group text-center">
        <div class="rounded-[30px] overflow-hidden shadow-md ring-1 ring-black/10 h-[300px]">
          <img src="assets/img/pobladores.png" alt="Carteras"
               class="w-full h-full object-cover transition-transform duration-200 group-hover:scale-[1.03]" />
        </div>
        <p class="mt-3 text-base font-medium text-white">Taquile, Perú</p>
      </a>

      <a href="/categorias/carteras" class="group text-center">
        <div class="rounded-[30px] overflow-hidden shadow-md ring-1 ring-black/10 h-[300px]">
          <img src="assets/img/familias.png" alt="Carteras"
               class="w-full h-full object-cover transition-transform duration-200 group-hover:scale-[1.03]" />
        </div>
        <p class="mt-3 text-base font-medium text-white">Shipibo, Perú</p>
      </a>
    </div>
  </div>
</section>
