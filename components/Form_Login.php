<section class="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 via-fuchsia-600 to-purple-700 p-4">
  <!-- Card: estira columnas e impone altura mínima -->
  <div class="mx-auto max-w-6xl grid md:grid-cols-2 gap-6 bg-white rounded-2xl p-4 sm:p-8 shadow-xl md:items-stretch md:min-h-[580px]">

    <!-- Columna Izquierda: Imagen + Logo (llena alto) -->
    <div class="relative rounded-2xl overflow-hidden order-2 md:order-1 h-60 md:h-full">
      <img src="assets/img/aguja.png" alt="Tela y herramientas de costura" class="w-full h-full object-cover"/>
    ...
    <!-- Columna Derecha: Form (llena alto) -->
    <div class="flex flex-col h-full order-1 md:order-2">
      <!-- Contenido principal ocupa el espacio (footer queda abajo) -->
      <div class="flex-1 flex flex-col">
        <h1 class="text-5xl font-semibold text-center">Iniciar Sesión</h1>
        <hr class="mt-2 mb-8 border-black/20" />

        <!-- Form ocupa el alto disponible -->
        <form id="form-login"
              class="flex-1 flex flex-col justify-center space-y-6"
              method="post"
              action="/MAYWATEXTIL/api/auth/login.php"
              autocomplete="on"
              novalidate>
          <!-- Correo -->
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2" for="login_correo">Correo electrónico:</label>
            <div class="relative">
              ...
              <input id="login_correo" type="email" name="correo" placeholder="tuemail@dominio.com" required
          ...
          <!-- Contraseña -->
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2" for="login_pass">Contraseña:</label>
            <div class="relative">
              <span class="absolute left-4 top-1/2 -translate-y-1/2 text-purple-600">
                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <input id="login_pass" type="password" name="contrasena" placeholder="Tu contraseña" required
              ...
              <button type="button" id="toggle-pass"
                      class="absolute right-4 top-1/2 -translate-y-1/2 text-purple-600 transition transform duration-150 ease-out active:scale-95"
                ...
                <svg id="icon-eye-off" class="h-6 w-6 hidden" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" d="M17.94 17.94A10.94 10.94 0 0112 19c-7 0-11-7-11-7a20.59 20.59 0 014.32-4.91M9.9 4.24A10.93 10.93 0 0112 5c7 0 11 7 11 7a20.66 20.66 0 01-3.62 4.35"/>
                  <path stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" d="M1 1l22 22"/>
                </svg>
              </button>
            </div>
          </div>
          ...
          <div class="flex items-center justify-between text-sm">
            ...
            <a href="/MAYWATEXTIL/api/auth/forgot_password.php" class="text-gray-700 hover:text-purple-700 text-base">¿Olvidaste tu contraseña?</a>
          </div>

          <!-- A registro -->
          <a href="/MAYWATEXTIL/public/index.php?page=register" class="block text-base text-purple-700 hover:underline">
      ...
      <div class="mt-12 text-center text-sm text-gray-500 space-y-1">
        ...
        <p>
          <a href="/MAYWATEXTIL/public/index.php?page=soporte" class="hover:text-purple-700">Soporte</a> •
          <a href="/MAYWATEXTIL/public/index.php?page=contacto" class="hover:text-purple-700">Contacto</a> •
          <a href="/MAYWATEXTIL/public/index.php?page=ayuda" class="hover:text-purple-700">Ayuda</a>
        </p>
      </div>
    </div>
  </div>
...
<script>
  // Enviar con fetch y redirigir cuando el login sea correcto
